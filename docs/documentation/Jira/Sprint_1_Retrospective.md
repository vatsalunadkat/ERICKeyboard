...
**Velocity**: 11 tasks completed (no story points used in Sprint 1)  
...
| Group | Focus Area |
|---|---|
| **Group 1** | Research (keyboard/joystick library exploration) |
| **Group 2** | Lead UI Design + Documentation |
...
### Pre-Phase Planning & Task Design

| # | Action | Owner |
|---|---|---|
| 1 | Complete full Sprint 2 planning slightly in advance with fixed core goals and acceptance criteria; ensure >90% of content will not change mid-sprint | Product Owner |
| 2 | Formulate all user stories and task details initially, then organize a team discussion on Monday to optimize descriptions and refine acceptance criteria based on feedback | Product Owner + Team |
| 3 | Balance individual responsibilities with team collaboration when splitting tasks; assign groups based on experience levels and Sprint 1 outcomes (e.g., pair experienced members with newcomers) | Scrum Master |

### Communication & Collaboration

| # | Action | Owner |
|---|---|---|
| 4 | Consult the Product Owner directly for product-related issues; Scrum Master handles task management and stand-up organization; raise uncertain issues in group chat to gather input | All |
| 5 | Record work and task completion details in the shared OneDrive documents (Agile Task Tracking.xlsx, group folders); share and archive research results and development progress; record issues and resolutions (also submit bugs/requests in Jira) | All |

### Agile Team Management

| # | Action | Owner |
|---|---|---|
| 6 | Mark completed user stories as "Completed" during daily stand-ups and before Sprint Review to clarify task progress | Product Owner |
| 7 | Assume the role of assisting the Product Owner; follow up on user story assignments and task completion; act as a communication bridge between the PO and team members | Scrum Master |
| 8 | Quickly summarize the task completion status of each group at the start of the Sprint Review meeting | Scrum Master |
